...
const Contact = () => {
  ...
  return (
    <section className="py-32 bg-white dark:bg-[#0a0a0a] transition-colors duration-300 relative overflow-hidden">
      ...
      {/* Background flare */}
      <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-[500px] h-[500px] bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-[300px]">
          ...
          <motion.div
            ...
            className="group relative bg-[#f5f5f7] dark:bg-[#1a1a1c] rounded-[2rem] p-10 flex flex-col justify-between overflow-hidden border border-transparent dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10 transition-colors"
          >
