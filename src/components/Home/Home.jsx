...
const Home = () => {
  ...
  return (
    <section id="home" className="your-existing-classes">
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-center p-4 relative top-16">
        ...
        >
          <button 
            ...
            className="flex items-center space-x-2 text-gray-400 hover:text-blue-400 transition duration-300 hover:scale-105 transform bg-transparent border-none cursor-pointer"
          >
